...
<div className="w-full h-fit  flex flex-row justify-between">
  <h2 className=" font-bold mb-2 text-[#e89b53] font-[Dancing_Script] text-md sm:text-3xl">Natal Dates for {formState?.user}</h2>
 ...
 <div className=" h-fit sm:p-4 p-1">
  <h2 className="text-md sm:text-3xl font-bold mb-2 text-[#e89b53] font-[Dancing_Script]">Transit Dates for {formState?.moment}</h2>
  <div className="space-y-2">
    <div className="flex justify-between  ">
    ...
    <div className="flex justify-between  ">
      <span className="font-medium ">Transit Time</span><div className="flex sm:flex-col flex-row">
