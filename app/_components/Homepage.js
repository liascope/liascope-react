...
import Button from "./Button";
 ...
 export default function Homepage (){
  return  <main>  <h2 className="text-[#e89b53] text-xl text-center py-8 mb-14 -mt-4"> A quick & precise way to get an insight of the most important astrological charts of your scope.
      </h2> <div className="flex items-center justify-center top-0 tracking-wider relative min-h-screen w-full pb-72">  
